...
public class ProductController {
	...
	@PostMapping
	public ProductRest createProduct(@RequestBody ProductRequestModel product) {
	...
	@PutMapping("/{id}")
	public ProductRest updateProduct(@RequestBody ProductRequestModel product ,@PathVariable String id) {
